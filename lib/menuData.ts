...
// Add a category ID here to hide it from the menu without deleting its data
const HIDDEN_CATEGORIES = ['french-toasts'];
...
export const categories = allCategories.filter(c => !HIDDEN_CATEGORIES.includes(c.id));
...
const allMenuItems: MenuItem[] = [
  ...
  // ─── FRENCH TOASTS ─────────────────────────────────────────────────
  {
    id: 'ft-01', category: 'french-toasts', name: 'Classic French Toast', price: 179, veg: true, mustTry: false,
  ...
  {
    id: 'ft-02', category: 'french-toasts', name: 'Caramel French Toast', price: 209, veg: true, mustTry: false,
  ...
  {
    id: 'ft-03', category: 'french-toasts', name: 'Strawberry French Toast', price: 229, veg: true, mustTry: true,
  ...
  {
    id: 'ft-04', category: 'french-toasts', name: 'Mango French Toast', price: 249, veg: true, mustTry: true,
